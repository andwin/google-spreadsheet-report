...
const batchUpdate = (sheets, request) =>
  new Promise((resolve, reject) => {
...
const valuesGet = (sheets, request) =>
  new Promise((resolve, reject) => {
...
const valuesAppend = (sheets, request) =>
  new Promise((resolve, reject) => {
...
const valuesUpdate = (sheets, request) =>
  new Promise((resolve, reject) => {
